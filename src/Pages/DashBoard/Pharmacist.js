...
const Pharmacist = () => {
    ...
    const { data: pharmacists, isLoading, refetch } = useQuery('pharmacists', () => fetch(' https://hospital-management-9ou8.onrender.com/pharmacist', {
        headers: {
    ...
    const handleSearch = e => {
        ...
        fetch(` https://hospital-management-9ou8.onrender.com/pharmacists?name=${search}`)
          .then(res => res.json())
          .then(data => {
            setPharmacists(data)
