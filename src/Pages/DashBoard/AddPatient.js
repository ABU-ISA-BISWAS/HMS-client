...
const AddPatient = () => {
    ...
    return (
        <div className=''>
            <Link className='bg-yellow-500 border-2 border-yellow-500 rounded-lg p-2 mb-4' to="/dashboard/patient">  ⇚</Link>
        <h2 className='ml-1 font-serif font-bold text-lg text-sky-800 mt-5'>Add a new patient</h2>
