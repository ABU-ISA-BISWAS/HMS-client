...
const Doctor = () => {
  ...
  const {data:doctors,isLoading,refetch}=useQuery('doctors',()=>fetch(' https://hospital-management-9ou8.onrender.com/doctor',{
      headers:{
  ...
  const handleSearch = e => {
    ...
    fetch(` https://hospital-management-9ou8.onrender.com/doctors?name=${search}`)
      .then(res => res.json())
      .then(data => {
        setDoctors(data)
