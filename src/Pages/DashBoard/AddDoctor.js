...
const AddDoctor = () => {
    ...
    return (
        <div className=''>
            <Link className='bg-yellow-500 border-2 border-yellow-500 rounded-lg p-2 mb-4' to="/dashboard/doctor">  ⇚</Link>
            <h2 className='ml-1 font-serif font-bold text-lg text-sky-800 mt-5'>Add a new doctor</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div class="form-control w-full max-w-xs">
                    ...
                    <select {...register('specialty')} class="input-bordered input-sm select w-full max-w-xs">
                ...
                <div class="form-control w-full max-w-xs">
                    ...
                    <input className='btn bg-sky-800 w-full max-w-xs' type="submit" value="Add" />
