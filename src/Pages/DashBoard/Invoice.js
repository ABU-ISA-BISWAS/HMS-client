...
class Invoice extends Component {
  ...
  //   axios.post(' https://hospital-management-9ou8.onrender.com/create-pdf', this.state)
  //     .then(() => axios.get(' https://hospital-management-9ou8.onrender.com/fetch-pdf', { responseType: 'blob' }))
  //     .then((res) => {
