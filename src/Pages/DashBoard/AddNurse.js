...
const AddNurse = () => {
    ...
    const onSubmit = async data => {
        ...
        .then(result=>{
           if(result.success){
               ...
               fetch(' https://hospital-management-9ou8.onrender.com/nurse',{
                   method:'POST',
                   headers:{
               ...
               .then(inserted=>{
                if(inserted.insertedId){
                    ...
                    toast.error('Failed to add the Nurse');
                }
               })
           }
        })
    ...
    return (
        <div className=''>
            <Link className='bg-yellow-500 border-2 border-yellow-500 rounded-lg p-2 mb-4' to="/dashboard/nurse">  ⇚</Link>
        <h2 className='ml-1 font-serif font-bold text-lg text-sky-800 mt-5'>Add a new nurse</h2>
